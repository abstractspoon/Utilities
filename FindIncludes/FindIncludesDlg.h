...
#include "..\..\ToDoList_Core\shared\groupline.h"
...
protected:
	...
	void DoSearch();
	int DoSearch(INCLUDEFILEITEM& fi, HTREEITEM htiParent, CMap<CString, LPCTSTR, BOOL, BOOL&>& mapVisited);
