========================================================================
       DEVELOPER STUDIO ADD-IN : ProjectZip
========================================================================


The Add-in Wizard has created this ProjectZip DLL for you.  This DLL not only
...
make up your ProjectZip DLL.


ProjectZip.h
	This is the main header file for the DLL.  It declares the
	CProjectZipApp class.

ProjectZip.cpp
	This is the main DLL source file.  It contains the class CProjectZipApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (ProjectZipCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named ProjectZip.pch and a precompiled types file named StdAfx.obj.
